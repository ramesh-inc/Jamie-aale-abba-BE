...
export default function ParentSidebar({ isOpen, isCollapsed, onClose, onToggleCollapse: _onToggleCollapse, activeItem, onItemSelect, onLogout }: ParentSidebarProps) {
          ...
          {!isCollapsed && (
            <>
              ...
              <div className="text-center">
                <h2 className="text-base font-semibold text-gray-900">Parent Portal</h2>
              </div>
            </>
          )}
