...
const PhotoStoryModal: React.FC<PhotoStoryModalProps> = ({
  isOpen,
  onClose,
  onStoryCreated
}) => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      submitData.append('story_type', 'photo');
      ...
      <form onSubmit={handleSubmit} className="space-y-6">
        ...
        <div>
          ...
          <input
            ...
            placeholder="Enter photo story title"
            maxLength={100}
          />
          {errors.title && (
        ...
        <div className="flex justify-end space-x-3 pt-4 border-t border-gray-200">
          ...
          <button
            ...
            className="px-4 py-2 text-sm font-medium text-white bg-amber-600 border border-transparent rounded-md hover:bg-amber-700 focus:outline-none focus:ring-2 focus:ring-amber-500 disabled:opacity-50 disabled:cursor-not-allowed transition-colors flex items-center"
          >
            {isLoading ? (
              <>
